...
public class AutoCompleteDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * <p>Sets the current height for the auto-complete drop down list.
		 * <p>Sets the current width for the auto-complete drop down list.
		 */
		edit.setDropDownHeight(200);
	...
	private String[] strs = new String[] { "wujianqiang", "zhangmeijing", "lixiuting",
			...
			"machao","zhangli","zhaobo","zhguang","zhoufei"
			 };
