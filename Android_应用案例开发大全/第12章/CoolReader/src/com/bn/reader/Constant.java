...
public class Constant
{
	...
	//初始背景和字体颜色
	public static int BITMAP=R.drawable.bg_sjzx;//初始的背景图片
	...
	{
		//分割线自适应
		CENTER_LEFT_X=(SCREEN_WIDTH-CENTER_WIDTH)/2;//给中间分割线左上角x坐标
		CENTER_RIGHT_X=CENTER_LEFT_X+CENTER_WIDTH-1;//给中间分割线 右下角x坐标
		CENTER_RIGHT_Y=SCREEN_HEIGHT;//给中间分割线 右下角y坐标
		//右侧图片左定点X坐标自适应
		RIGHT_OR_LEFT_x=CENTER_RIGHT_X+1;//给右侧图片左定点的x坐标
		//虚拟页高宽自适应
		PAGE_WIDTH=(SCREEN_WIDTH-CENTER_WIDTH)/2;//虚拟页的宽度
