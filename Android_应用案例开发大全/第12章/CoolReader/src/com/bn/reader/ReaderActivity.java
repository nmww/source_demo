       	        ...
       	        lv.setOnItemClickListener(
       	           new OnItemClickListener()
       	           {
       				...
       				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
   						...
   						Constant.CURRENT_LEFT_START=readerView.currRR.leftStart;//记录当前读到处leftstart的值
	...
	public void isWhichTime()//判断是第几次打开软件
	{
        ...
        }else//否则，获取上一次打开书的“路径”与“页数”
        {
        	...
        	try{
        		...
        		Constant.CURRENT_LEFT_START=readerView.currRR.leftStart;//为当前书页左上索引赋值
	...
	public void updataBookMarkAndHashMap()
	{
		...
		if(haveBookMark)//如果存在书签
		{
		   ...
		   for(int i=0;i<dataBaseBookMark.size();i++)
		   {
			   ...
			   leftStart[m]=readerView.currRR.leftStart;//获取leftstart的值  
		   }
